...
## Local Running {style="text-align: center;"}

![](videos/survey-building.mp4){style="border: 2px solid #5654A2;"}

## Online Deployment {style="text-align: center;"}

::: {style="text-align: left;"}
### `shinyapps.io` {style="font-size: 36px; color: #739C69; padding-top: 2em;"}
...
### Other Platforms {style="font-size: 36px; color: #739C69; padding-top: 2em;"}
...
## Map Question Demo {style="text-align: center;"}
...
![](videos/map-showcase.mov){style="border: 2px solid #5654A2; width: 100%;"}
