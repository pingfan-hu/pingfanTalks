...
## Data Management in Supabase {style="text-align: center;"}

![](figs/supabase_1.png){width="80%" fig-align="center" style="border: 2px solid #5654A2;"}
...
![](figs/supabase_2.png){width="80%" fig-align="center" style="border: 2px solid #5654A2;"}

::: {style="text-align: center;"}
Survey Data
:::

## Data Management in `surveydown` Dashboard {style="text-align: center;"}

![](figs/dashboard_1.png){width="80%" fig-align="center" style="border: 2px solid #5654A2;"}
...
![](figs/dashboard_2.png){width="80%" fig-align="center" style="border: 2px solid #5654A2;"}
