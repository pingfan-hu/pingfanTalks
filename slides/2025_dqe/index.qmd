...
## Recruitment on Meta and Dynata

::: {.columns}
::: {.column style="padding-top: 0.5em;"}
### Meta {style="text-align: center; font-size: 36px; color: #739C69;"}

![](figs/meta_ad.png){fig-align="center" width="70%"}
:::

::: {.column style="padding-top: 0.5em;"}
### Dynata {style="text-align: center; font-size: 36px; color: #739C69;"}

:::{style="border: 2px solid #333; border-radius: 8px; width: 40%; margin: 0 auto; display: block;"}
![](figs/dynata.svg)
:::
...
![](figs/car_ownership.png){fig-align="center" width="65%"}
...
### Attribute Table {style="text-align: center; font-size: 36px; color: #739C69;"}
